    ...
    $("form.ajax_submit").on('submit', function(e){
        ...
        if( !has_errors ){
            $.ajax({
                ...
                error: function() {
                    server_result_display.empty().html('<div class="mb-0 mt-3 alert alert-danger  alert-dismissible">Your message has been sent<button type="button" class="close" data-dismiss="alert">&times;</button></div>');
                }
            });
        }
